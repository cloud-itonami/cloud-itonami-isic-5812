# Operator Quickstart — Publishing of Directories and Mailing Lists

Shortest path from clone to a verified local dry-run for **ISIC 5812** (`cloud-itonami-isic-5812`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5812.git
cd cloud-itonami-isic-5812
```
...
- Blueprint governor key: `dirmail-governor`
- Likely source path: `dirmailops.governor.cljc`
